{
    "name": "Hells Pass 1v1 Shared",
    "creator": "TheEffectTheCause",
    "version": "1",
    "description": "For 1v1 Shared Teams. Battle around a central crevice that blocks the closest route to the enemy, the rear of the planet is littered with pathways. Position is key.",
    "players": [
        2,
        4
    ],
